...
class SearchList extends Component {
  constructor(props) {
    ...
    this.store = this.props.getDailyStore;
  }
  ...
  render() {
    const { /* create, */ search, remove, data, contractes } = this.store;
    return (
      <div>
        <PageHeader title="计划列表" content="" breadcrumbList={[{ title: '计划管理' }]} />
        <div className="content-card">
          <FilterForm data={contractes} onSubmit={search} />
          <br />
